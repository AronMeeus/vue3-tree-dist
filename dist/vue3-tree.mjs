...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock("li", {
    ...
    createVNode("div", {
      ...
      $props.node && $props.useRowDelete ? (openBlock(), createBlock("div", {
        key: 2,
        class: "delete-icon",
    ...
    $props.node.expanded ? (openBlock(), createBlock("ul", {
      ...
      (openBlock(true), createBlock(Fragment, null, renderList($props.node.nodes, (child) => {
        return openBlock(), createBlock(_component_tree_row, {
          key: child.id,
          ...
          _: 2
        }, 1032, ["node", "use-checkbox", "use-icon", "use-row-delete", "show-child-count", "gap", "expand-row-by-default", "indent-size", "row-hover-background", "set-node", "get-node", "update-node", "expandable", "onDeleteRow", "onToggleCheckbox", "onNodeExpanded"]);
      }), 128))
...
const _withId = /* @__PURE__ */ withScopeId("data-v-4af757df");
pushScopeId("data-v-4af757df");
  ...
  return openBlock(), createBlock("div", _hoisted_1, [
    createVNode("ul", {
      ...
      (openBlock(true), createBlock(Fragment, null, renderList($setup.filteredData, (node) => {
        ...
        ]), 1032, ["node", "use-checkbox", "use-icon", "use-row-delete", "show-child-count", "indent-size", "gap", "row-hover-background", "set-node", "get-node", "update-node", "expandable", "onDeleteRow", "onNodeClick", "onNodeExpanded", "onToggleCheckbox"]);
      }), 128))
    ], 4)
  ]);
});
_sfc_main.render = _sfc_render;
_sfc_main.__scopeId = "data-v-4af757df";
